...
function ProfileUpdate() {
 ...
 const [redirectUrlValue,setRedirectUrl]=useState("")
  ...
  console.log("redirectURL from state",redirectUrlValue);
  ...
  const onSubmit = async (values) => {
    ...
    // welcomeMessage(name)
    // let redirectRoute=localStorage.getItem('currentUrl')
    if(redirectUrlValue){
      console.log("REDIRECT URL form profileUpdate submission", redirectUrlValue);
    ...
    // const redirectUrl = router.query.redirectUrl || "/"; // Default redirect to homepage
    // const urlObject = typeof redirectUrl === 'string' ? { pathname: redirectUrl } : { pathname: redirectUrl[0] };
